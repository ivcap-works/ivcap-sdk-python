...
class NotImplementedT:
    ...
    Example:
        {'message': 'Laudantium cupiditate natus eligendi asperiores aliquam.'}

    Attributes:
        message (str): Information message Default: 'Method not implemented'. Example: Asperiores animi ducimus odit
            similique occaecati..
    """
