...
class NotImplementedT:
    ...
    Example:
        {'message': 'Inventore at dolorem.'}

    Attributes:
        message (str): Information message Default: 'Method not implemented'. Example: Nobis exercitationem consequuntur
            incidunt iste ducimus facere..
    """
